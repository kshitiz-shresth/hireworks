                ...
                <div class="card-body">
                    ...
                    <form class="ajax-form" method="POST" id="createForm">
                        ...
                        <div class="row" >
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="address">Job Description / Requirement</label>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="address">Job Status</label>
                            ...
                            <div class="col-md-4 teamMem" style="display: none">
                                <div class="form-group">
     ...
     $('#save-next-form').click(function () {
            $.easyAjax({
                ...
                success:function(data){
                    var url = "/admin/jobs/show?id={{ $job->id }}&page=3";
