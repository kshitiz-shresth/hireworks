            ...
            <div class="row">
                <div class="col-md-6  col-xs-12">
                    <div class="form-group">
                        <label class="d-block">Candidate Name</label>
            ...
            <div class="row">
                ...
                <div class="col-xs-5 col-md-4">
                    <div class="form-group chooseCandidate bootstrap-timepicker timepicker">
                        ...
                        <input type="time" name="scheduleTime" id="scheduleTime" placeholder="@lang('modules.interviewSchedule.scheduleTime')" class="form-control">
                    </div>
                </div>
            </div>
        </div>
