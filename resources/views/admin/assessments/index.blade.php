...
@section('content')
    ...
    <div class="row up_header">
        ...
        <div class="col-md-6 mb-20">
            ...
            <a><button class="btn btn-sm btn-primary pull-right"
                    ...
                    <div class="row">
                        ...
                        @foreach($assessments as $a)
                            <div class="col-md-4" style="padding:0px 40px 40px 0px;">
                                ...
                                <a class="nav-link mb-3 p-3 shadow" id="plusButton" href="/admin/assessments/show?id={{$a->id}}">
                                    <span class="font-weight-bold big"><br/>
                                    <h4 style="color:#0151ce">{{$a->name}}
                                    <span class="pull-right"><i onclick="return deleteAssessment(event,{{$a->id}})" class="fa fa-trash"></i></h2>
                                    <hr/>
