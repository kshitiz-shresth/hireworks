    ...
    <div class="container">
        ...
        <div class="topbar-left">
            ...
            @if(empty($global->logo))
                <img src="{{ asset('app-logo.png') }}"
                    class="brand-image img-fluid" class="logo-inverse" alt="{{ $global->company_name }}" >
                @else
                <img src="{{ asset('user-uploads/company-logo/'.$global->logo.'') }}" alt="{{ $global->company_name }}"
                class="logo-inverse">
                @endif
            </a>
        </div>
        <!-- <div class="topbar-right">
              <div class="row">
                  <div class="col-sm-6" style="color:white;border:none;padding:15px;">
                  <a href="#" >  Home</a>
                  </div>
                  <div class="col-sm-6" style="color:white;border:none;padding:15px;">
                    <a href="#" >Home2</a>
...
<!-- Header -->
<header class="header header-inverse" style="background-image: url({{ asset('front/assets/img/header-bg.jpg') }});height:50px;" data-overlay="8">
