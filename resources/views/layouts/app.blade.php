...
<body onload="greet()" @if(Auth::user()->id!=104)class="menu-open"@endif>
    ...
    <div class="" id="header-container">
        ...
        <div class="menu-logo">
            ...
            @if(empty($global->logo))
                <img src="{{ asset('app-logo.png') }}" style="max-width:150px" alt="{{ $global->company_name }}" >
            @else
                <img src="{{ asset('user-uploads/company-logo/'.$global->logo.'') }}" style="max-width:100%;height:50px;"  alt="{{ $global->company_name }}">
            @endif
        </div>
    ...
    <div id="side-menu">
        <div class="side-menu-wrapper">
            ...
            <ul class="menu-main">
                ...
                <li class="{{  Request::segment(2)=="job-applications" && Request::segment(3)=="table-view" ? 'active-link' : '' }}">
                ...
                <li class="{{  Request::segment(2)=="profile" || Request::segment('2')=='settings' ? 'active-link' : '' }}">
  ...
  <script>
    ...
    function greet(){
            ...
            if(hrs < 12)
            document.getElementById("greeting").innerHTML = "Good Morning! "+"{{ Auth::user()->name }}"
            if(hrs >= 12 && hrs < 17)
