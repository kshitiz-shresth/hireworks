...
class InterviewScheduleController extends AdminBaseController
{
    ...
    public function appointment()
    {
        ...
        return view('admin.interview-schedule.appointment',$this->data);
    }
    ...
    public function create(Request $request){
        ...
        $mSql = 'SELECT job_applications.id, job_applications.full_name FROM job_applications
        inner join jobs on job_applications.job_id = jobs.id
        where jobs.company_id ='.$this->user->company_id;

        $this->candidates = DB::select($mSql);
    ...
    public function employeeResponse($id, $res){
        ...
        $users = User::where('company_id',$this->user->company_id)->get(); // Get All admins for mail
        $type = 'refused';
